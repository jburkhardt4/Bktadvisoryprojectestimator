...
export function ScheduleCallButton({ 
  ...
  const getButtonClass = () => {
    ...
    switch (variant) {
      case 'nav':
        return `${baseClass} whitespace-nowrap px-3.5 py-2 bg-blue-700 text-white text-sm rounded-lg hover:bg-blue-600 hover:shadow-[0_0_20px_rgba(29,78,216,0.4)] hover:scale-[1.02] active:scale-[0.98] ${className}`;
      case 'footer':
